  ...
  return (
    <section id="contact" style={{
      ...
      <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
        ...
        <h2 style={{ fontSize: "clamp(2.5rem, 6vw, 4.5rem)", fontWeight: 700, letterSpacing: "-0.02em", marginBottom: 24 }}>
          Let&apos;s Talk
        </h2>
        <p style={{ color: "#a1a1aa", fontSize: 18, fontWeight: 300, marginBottom: 48 }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 32, color: "#52525b", fontSize: 11, letterSpacing: "0.15em", textTransform: "uppercase", flexWrap: "wrap" }}>
          <span>Pittsburgh, PA</span>
          <span style={{ width: 4, height: 4, borderRadius: "50%", background: "#27272a" }} />
